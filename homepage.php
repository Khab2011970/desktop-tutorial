...
<?php 
  ...
  if(isset($_SESSION['fullname'])) {
    ...
    if ($result->num_rows > 0) { 
      ...
      echo '<img src="'.'./uploads/'.$row['img_profile'].'" alt="Ảnh đại diện">'; 
    } 
  } 
  ?>
</b></h3>
...
<footer class="w3-padding-64 w3-light-grey w3-small w3-center" id="footer">
    ...
    <!-- Add logout and change password buttons here -->
    <div class="w3-padding-24">
        <a href="thoat.php" class="w3-button w3-black w3-round-large">Logout</a>
        <a href="formsua_mk.php" class="w3-button w3-black w3-round-large">Change Password</a>
    </div>
</footer>
